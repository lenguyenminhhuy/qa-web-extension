        ...
        if (event.keyCode === 13) {
            ...
            if (question === "") {
                ...
                chrome.runtime.onMessage.addListener(function (
                    ...
                    if (
                        message.greeting === "Hi popup, there are the answers"
                    ) {
                        ...
                        var firstAnswerStar =
                            document.getElementById("first-answer-star");
                        var secondAnswerStar =
                            document.getElementById("second-answer-star");
                        var thirdAnswerStar =
                            document.getElementById("third-answer-star");
                        ...
                        firstAnswerStar.addEventListener("click", async () => {
                            ...
                            const rawResponse = await fetch(
                                "http://localhost:3000/rating_answer",
                                {
                                    method: "POST",
                                    headers: {
