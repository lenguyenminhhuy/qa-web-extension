...
# get evaluation on oodomain_val set
python3 train.py --do-eval --run-name eval-tapt_model --eval-dir datasets/oodomain_val --checkpoint_path save/tapt_distilBert-01/checkpoint